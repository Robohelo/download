...
typedef cv::CvFeatureParams::FeatureType CvFeatureParams_FeatureType;
CV_PY_FROM_ENUM(CvFeatureParams_FeatureType);
CV_PY_TO_ENUM(CvFeatureParams_FeatureType);
