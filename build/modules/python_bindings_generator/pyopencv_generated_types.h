...
CVPY_TYPE(cuda_LookUpTable, Ptr<cv::cuda::LookUpTable>, Ptr, Algorithm, 0);
CVPY_TYPE(cuda_DFT, Ptr<cv::cuda::DFT>, Ptr, Algorithm, 0);
CVPY_TYPE(cuda_Convolution, Ptr<cv::cuda::Convolution>, Ptr, Algorithm, 0);
...
CVPY_TYPE(cuda_Filter, Ptr<cv::cuda::Filter>, Ptr, Algorithm, 0);
CVPY_TYPE(cuda_CLAHE, Ptr<cv::cuda::CLAHE>, Ptr, CLAHE, 0);
CVPY_TYPE(cuda_CannyEdgeDetector, Ptr<cv::cuda::CannyEdgeDetector>, Ptr, Algorithm, 0);
CVPY_TYPE(cuda_HoughLinesDetector, Ptr<cv::cuda::HoughLinesDetector>, Ptr, Algorithm, 0);
CVPY_TYPE(cuda_HoughSegmentDetector, Ptr<cv::cuda::HoughSegmentDetector>, Ptr, Algorithm, 0);
CVPY_TYPE(cuda_HoughCirclesDetector, Ptr<cv::cuda::HoughCirclesDetector>, Ptr, Algorithm, 0);
CVPY_TYPE(cuda_CornernessCriteria, Ptr<cv::cuda::CornernessCriteria>, Ptr, Algorithm, 0);
CVPY_TYPE(cuda_CornersDetector, Ptr<cv::cuda::CornersDetector>, Ptr, Algorithm, 0);
CVPY_TYPE(cuda_TemplateMatching, Ptr<cv::cuda::TemplateMatching>, Ptr, Algorithm, 0);
...
CVPY_TYPE(cudacodec_EncoderParams, Ptr<cv::cudacodec::EncoderParams>, Ptr, NoBase, 0);
CVPY_TYPE(cudacodec_EncoderCallBack, Ptr<cv::cudacodec::EncoderCallBack>, Ptr, NoBase, 0);
CVPY_TYPE(cudacodec_VideoWriter, Ptr<cv::cudacodec::VideoWriter>, Ptr, NoBase, 0);
CVPY_TYPE(cudacodec_VideoReader, Ptr<cv::cudacodec::VideoReader>, Ptr, NoBase, 0);
CVPY_TYPE(cudacodec_RawVideoSource, Ptr<cv::cudacodec::RawVideoSource>, Ptr, NoBase, 0);
CVPY_TYPE(cuda_DescriptorMatcher, Ptr<cv::cuda::DescriptorMatcher>, Ptr, Algorithm, 0);
CVPY_TYPE(cuda_Feature2DAsync, Ptr<cv::cuda::Feature2DAsync>, Ptr, Feature2D, 0);
CVPY_TYPE(cuda_FastFeatureDetector, Ptr<cv::cuda::FastFeatureDetector>, Ptr, cuda_Feature2DAsync, 0);
CVPY_TYPE(cuda_ORB, Ptr<cv::cuda::ORB>, Ptr, cuda_Feature2DAsync, 0);
CVPY_TYPE(cuda_StereoBM, Ptr<cv::cuda::StereoBM>, Ptr, StereoBM, 0);
CVPY_TYPE(cuda_StereoBeliefPropagation, Ptr<cv::cuda::StereoBeliefPropagation>, Ptr, StereoMatcher, 0);
CVPY_TYPE(cuda_StereoConstantSpaceBP, Ptr<cv::cuda::StereoConstantSpaceBP>, Ptr, cuda_StereoBeliefPropagation, 0);
CVPY_TYPE(cuda_DisparityBilateralFilter, Ptr<cv::cuda::DisparityBilateralFilter>, Ptr, Algorithm, 0);
...
CVPY_TYPE(cuda_BackgroundSubtractorMOG, Ptr<cv::cuda::BackgroundSubtractorMOG>, Ptr, BackgroundSubtractor, 0);
CVPY_TYPE(cuda_BackgroundSubtractorMOG2, Ptr<cv::cuda::BackgroundSubtractorMOG2>, Ptr, BackgroundSubtractorMOG2, 0);
CVPY_TYPE(cuda_HOG, Ptr<cv::cuda::HOG>, Ptr, Algorithm, 0);
CVPY_TYPE(cuda_CascadeClassifier, Ptr<cv::cuda::CascadeClassifier>, Ptr, Algorithm, 0);
...
CVPY_TYPE(cuda_DenseOpticalFlow, Ptr<cv::cuda::DenseOpticalFlow>, Ptr, Algorithm, 0);
CVPY_TYPE(cuda_SparseOpticalFlow, Ptr<cv::cuda::SparseOpticalFlow>, Ptr, Algorithm, 0);
CVPY_TYPE(cuda_NvidiaHWOpticalFlow, Ptr<cv::cuda::NvidiaHWOpticalFlow>, Ptr, Algorithm, 0);
CVPY_TYPE(cuda_BroxOpticalFlow, Ptr<cv::cuda::BroxOpticalFlow>, Ptr, cuda_DenseOpticalFlow, 0);
CVPY_TYPE(cuda_SparsePyrLKOpticalFlow, Ptr<cv::cuda::SparsePyrLKOpticalFlow>, Ptr, cuda_SparseOpticalFlow, 0);
CVPY_TYPE(cuda_DensePyrLKOpticalFlow, Ptr<cv::cuda::DensePyrLKOpticalFlow>, Ptr, cuda_DenseOpticalFlow, 0);
CVPY_TYPE(cuda_FarnebackOpticalFlow, Ptr<cv::cuda::FarnebackOpticalFlow>, Ptr, cuda_DenseOpticalFlow, 0);
CVPY_TYPE(cuda_OpticalFlowDual_TVL1, Ptr<cv::cuda::OpticalFlowDual_TVL1>, Ptr, cuda_DenseOpticalFlow, 0);
CVPY_TYPE(cuda_NvidiaOpticalFlow_1_0, Ptr<cv::cuda::NvidiaOpticalFlow_1_0>, Ptr, cuda_NvidiaHWOpticalFlow, 0);
